...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.deviceInfoLabel.setGeometry(QtCore.QRect(20, int(screen_height/2), 400, 30))  # Positioned at the top-left
        ...
        self.bnStart.setGeometry(QtCore.QRect(300, int(screen_height/2), 125, 40))  # Positioned at the top-right
        ...
        self.bnStop.setGeometry(QtCore.QRect(450, int(screen_height/2), 125, 40))  # Positioned next to Start button
        ...
        self.bnRefresh.setGeometry(QtCore.QRect(600, int(screen_height/2), 100, 40))  # Positioned next to Stop button
        ...
        self.bnExit.setGeometry(QtCore.QRect(750, int(screen_height/2), 80, 40))  # Positioned next to Refresh button
