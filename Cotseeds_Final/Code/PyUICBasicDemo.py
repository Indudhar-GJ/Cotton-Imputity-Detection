...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bnStart.setGeometry(QtCore.QRect(500, 20, 125, 40))  # Positioned at the top-right
        ...
        self.bnStop.setGeometry(QtCore.QRect(600, 20, 125, 40))  # Positioned next to Start button
        ...
        self.bnRefresh.setGeometry(QtCore.QRect(700, 20, 100, 40))  # Positioned next to Stop button
        ...
        self.bnExit.setGeometry(QtCore.QRect(800, 20, 80, 40))  # Positioned next to Refresh button
